...
{
   char *pointer;
   ((pcDest != ((void *)0)) ? (void) (0) : __assert_fail ("pcDest != ((void *)0)", "strp.c", 29, __PRETTY_FUNCTION__));
   ((pcSrc != ((void *)0)) ? (void) (0) : __assert_fail ("pcSrc != ((void *)0)", "strp.c", 30, __PRETTY_FUNCTION__));
   pointer = pcDest;
   while (*pcSrc) {
      *pointer = *pcSrc;
      pointer++;
...
{
   char *pointer;
   ((pcDest != ((void *)0)) ? (void) (0) : __assert_fail ("pcDest != ((void *)0)", "strp.c", 46, __PRETTY_FUNCTION__));
   ((pcSrc != ((void *)0)) ? (void) (0) : __assert_fail ("pcSrc != ((void *)0)", "strp.c", 47, __PRETTY_FUNCTION__));
   pointer = pcDest;
...
int Str_compare(const char *pcStr1, const char *pcStr2)
{
   ((pcStr1 != ((void *)0)) ? (void) (0) : __assert_fail ("pcStr1 != ((void *)0)", "strp.c", 66, __PRETTY_FUNCTION__));
   ((pcStr2 != ((void *)0)) ? (void) (0) : __assert_fail ("pcStr2 != ((void *)0)", "strp.c", 67, __PRETTY_FUNCTION__));
   while (*pcStr1) {
...
char *Str_search(const char *pcHaystack, const char *pcNeedle)
{
   ...
   ((pcHaystack != ((void *)0)) ? (void) (0) : __assert_fail ("pcHaystack != ((void *)0)", "strp.c", 96, __PRETTY_FUNCTION__));
   ((pcNeedle != ((void *)0)) ? (void) (0) : __assert_fail ("pcNeedle != ((void *)0)", "strp.c", 97, __PRETTY_FUNCTION__));
